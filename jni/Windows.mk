...
INC =  $(LOCAL_C_INCLUDES) -I/usr/i586-mingw32msvc/include/ -I/usr/i586-mingw32msvc/libpng/include

#Path to libs (again, standard setup for MinGW on Windows)
#begin each directory location with -L and each flag with -l
LIBS = -Llib -L/usr/i586-mingw32msvc/lib/ -L/usr/i586-mingw32msvc/libpng/lib -lpng -lmingw32 -lglee -lopengl32 -lglu32 -mwindows -lm -lole32 -lwinmm -lolepro32 -luuid
