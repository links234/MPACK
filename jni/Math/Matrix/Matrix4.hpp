...
namespace Math
{
	...
	template<class T> inline Matrix4<T> Matrix4<T>::operator* (const Matrix4<T> &matrix) const
	{
		Matrix4<T> rmatrix;
	...
	template<class T> inline void Matrix4<T>::SetIdentity(Matrix4<T> &matrix)
	{
	...
	template<class T> inline void Matrix4<T>::SetScale(Matrix4<T> &matrix, T x, T y, T z)
	{
	...
	template<class T> inline void Matrix4<T>::SetTrans(Matrix4<T> &matrix, T x, T y, T z)
	{
		matrix.m_matrix[0][0]=1; matrix.m_matrix[0][1]=0; matrix.m_matrix[0][2]=0; matrix.m_matrix[0][3]=0;
		matrix.m_matrix[1][0]=0; matrix.m_matrix[1][1]=1; matrix.m_matrix[1][2]=0; matrix.m_matrix[1][3]=0;
		matrix.m_matrix[2][0]=0; matrix.m_matrix[2][1]=0; matrix.m_matrix[2][2]=1; matrix.m_matrix[2][3]=0;
	...
	template<class T> inline void Matrix4<T>::SetRoll(Matrix4<T> &matrix, T angle)
	{
		angle=Misc<T>::DegToRad(angle);
		T cosa=Misc<T>::Cos(angle);
		T sina=Misc<T>::Sin(angle);
	...
	template<class T> inline void Matrix4<T>::SetPitch(Matrix4<T> &matrix, T angle)
	{
		angle=Misc<T>::DegToRad(angle);
		T cosa=Misc<T>::Cos(angle);
		T sina=Misc<T>::Sin(angle);
	...
	template<class T> inline void Matrix4<T>::SetYaw(Matrix4<T> &matrix, T angle)
	{
		angle=Misc<T>::DegToRad(angle);
		T cosa=Misc<T>::Cos(angle);
		T sina=Misc<T>::Sin(angle);
	...
	template<class T> inline void Matrix4<T>::SetRotationXYZ(Matrix4<T> &matrix, T x, T y, T z)
	{
		Matrix4<T> pitch,yaw,roll;
		SetPitch(pitch,x);
		SetYaw(yaw,y);
		SetRoll(roll,z);
	...
	template<class T> inline void Matrix4<T>::SetRotationXZY(Matrix4<T> &matrix, T x, T y, T z)
	{
		Matrix4<T> pitch,yaw,roll;
		SetPitch(pitch,x);
		SetYaw(yaw,y);
	...
	template<class T> inline void Matrix4<T>::SetRotationYXZ(Matrix4<T> &matrix, T x, T y, T z)
	{
		Matrix4<T> pitch,yaw,roll;
		SetPitch(pitch,x);
		SetYaw(yaw,y);
	...
	template<class T> inline void Matrix4<T>::SetRotationYZX(Matrix4<T> &matrix, T x, T y, T z)
	{
		Matrix4<T> pitch,yaw,roll;
		SetPitch(pitch,-x);
		SetYaw(yaw,y);
	...
	template<class T> inline void Matrix4<T>::SetRotationZXY(Matrix4<T> &matrix, T x, T y, T z)
	{
		Matrix4<T> pitch,yaw,roll;
		SetPitch(pitch,-x);
		SetYaw(yaw,y);
	...
	template<class T> inline void Matrix4<T>::SetRotationZYX(Matrix4<T> &matrix, T x, T y, T z)
	{
		Matrix4<T> pitch,yaw,roll;
		SetPitch(pitch,-x);
		SetYaw(yaw,y);
	...
	template<class T> inline void Matrix4<T>::SetAxisRotation(Matrix4<T> &matrix, Vector3<T> axis, T angle)
	{
		axis.Normalize();
		T &X=axis.x;
		T &Y=axis.y;
		T &Z=axis.z;
		angle=Misc<T>::DegToRad(angle);
		T c=Misc<T>::Cos(angle);
		T s=Misc<T>::Sin(angle);
		T t=1-c;
		T tX2=t*X*X;
		T tXY=t*X*Y;
		T tXZ=t*X*Z;
	...
	template<class T> inline void Matrix4<T>::SetInverseScale(Matrix4<T> &matrix, T x, T y, T z)
	{
	...
	template<class T> inline void Matrix4<T>::SetInverseTrans(Matrix4<T> &matrix, T x, T y, T z)
	{
		matrix.m_matrix[0][0]=1;  matrix.m_matrix[0][1]=0;  matrix.m_matrix[0][2]=0;  matrix.m_matrix[0][3]=0;
		matrix.m_matrix[1][0]=0;  matrix.m_matrix[1][1]=1;  matrix.m_matrix[1][2]=0;  matrix.m_matrix[1][3]=0;
		matrix.m_matrix[2][0]=0;  matrix.m_matrix[2][1]=0;  matrix.m_matrix[2][2]=1;  matrix.m_matrix[2][3]=0;
	...
	template<class T> inline void Matrix4<T>::SetInverseRoll(Matrix4<T> &matrix, T angle)
	{
		angle=Misc<T>::DegToRad(angle);
		T cosa=Misc<T>::Cos(angle);
		T sina=Misc<T>::Sin(angle);
	...
	template<class T> inline void Matrix4<T>::SetInversePitch(Matrix4<T> &matrix, T angle)
	{
		angle=Misc<T>::DegToRad(angle);
		T cosa=Misc<T>::Cos(angle);
		T sina=Misc<T>::Sin(angle);
	...
	template<class T> inline void Matrix4<T>::SetInverseYaw(Matrix4<T> &matrix, T angle)
	{
		angle=Misc<T>::DegToRad(angle);
		T cosa=Misc<T>::Cos(angle);
		T sina=Misc<T>::Sin(angle);
	...
	template<class T> inline void Matrix4<T>::SetInverseRotationXYZ(Matrix4<T> &matrix, T x, T y, T z)
	{
		SetRotationXYZ(matrix,-x,-y,-z);
	}

	template<class T> inline void Matrix4<T>::SetInverseRotationXZY(Matrix4<T> &matrix, T x, T y, T z)
	{
		SetRotationXZY(matrix,-x,-y,-z);
	}

	template<class T> inline void Matrix4<T>::SetInverseRotationYXZ(Matrix4<T> &matrix, T x, T y, T z)
	{
		SetRotationYXZ(matrix,-x,-y,-z);
	}

	template<class T> inline void Matrix4<T>::SetInverseRotationYZX(Matrix4<T> &matrix, T x, T y, T z)
	{
		SetRotationYZX(matrix,-x,-y,-z);
	}

	template<class T> inline void Matrix4<T>::SetInverseRotationZXY(Matrix4<T> &matrix, T x, T y, T z)
	{
		SetRotationZXY(matrix,-x,-y,-z);
	}

	template<class T> inline void Matrix4<T>::SetInverseRotationZYX(Matrix4<T> &matrix, T x, T y, T z)
	{
		SetRotationZYX(matrix,-x,-y,-z);
	}

	template<class T> inline void Matrix4<T>::SetInverseAxisRotation(Matrix4<T> &matrix, Vector3<T> axis, T angle)
	{
		axis.normalize();
		T &X=axis.x;
		T &Y=axis.y;
	...
	template<class T> inline void Matrix4<T>::SetOrtho(Matrix4<T> &matrix, T l, T r, T b, T t, T n, T f)
	{
	...
	template<class T> inline void Matrix4<T>::SetFrustum(Matrix4<T> &matrix, T l, T r, T b, T t, T n, T f)
	{
		T rl=static_cast<T>(1)/(r-l);
		T tb=static_cast<T>(1)/(t-b);
		T fn=static_cast<T>(1)/(f-n);
	...
	template<class T> inline void Matrix4<T>::SetPerspective(Matrix4<T> &matrix, T fov, T aspect, T n, T f)
	{
	...
	template<class T> inline void Matrix4<T>::SetCamera(Matrix4<T> &matrix, Vector3<T> look, Vector3<T> up, Vector3<T> right, Vector3<T> position)
	{
		look.Normalize();
		up.Normalize();
		right.Normalize();
	...
	template<class T> inline void Matrix4<T>::SetObject(Matrix4<T> &matrix, Vector3<T> look, Vector3<T> up, Vector3<T> right, Vector3<T> position)
	{
		look.Normalize();
		up.Normalize();
		right.Normalize();
	...
	template<class T> inline void Matrix4<T>::Transpose(Matrix4<T> &matrix)
	{
		Matrix4<T> t=matrix;
	...
	template<class T> inline void Matrix4<T>::Inverse(Matrix4<T> &matrix)
	{
		Matrix4<T> C;
