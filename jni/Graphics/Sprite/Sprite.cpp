...
void Sprite::Render()
{
	...
	SpriteVertex vertexData[]={	SpriteVertex(v[0].x,Render::GetScreenHeight()-v[0].y,	0,0,	m_color[0].x,m_color[0].y,m_color[0].z,m_color[0].w,	m_spriteShadingType),
								SpriteVertex(v[1].x,Render::GetScreenHeight()-v[1].y,	1,0,	m_color[1].x,m_color[1].y,m_color[1].z,m_color[1].w,	m_spriteShadingType),
								SpriteVertex(v[2].x,Render::GetScreenHeight()-v[2].y,	1,1,	m_color[2].x,m_color[2].y,m_color[2].z,m_color[2].w,	m_spriteShadingType),
								SpriteVertex(v[3].x,Render::GetScreenHeight()-v[3].y,	0,1,	m_color[3].x,m_color[3].y,m_color[3].z,m_color[3].w,	m_spriteShadingType) };
